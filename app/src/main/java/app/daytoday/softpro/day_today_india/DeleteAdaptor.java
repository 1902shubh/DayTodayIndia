...
public class DeleteAdaptor extends RecyclerView.Adapter<DeleteAdaptor.Exampleviewholder> {

    public List<news_data> mExamplelist;
    public Context mContext;

    public DeleteAdaptor(Context context, List<news_data> examplelist) {
        mContext = context;
